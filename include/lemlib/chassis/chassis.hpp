...
class OdomSensors {
    public:
         ...
         * @param distances pointer to the distance sensors
         *
         * @b Example
         * @code {.cpp}
         ...
         *                     &imu, // IMU
         *                     nullptr, // no distance sensors, set to nullptr
         * @endcode
         */
...
class Chassis {
    public:
        ...
        /**
         * @brief Correct odometry by distance sensors
         */
        ...
        /**
         * @brief Turn the chassis to point to a point (x, y) and move towards it
         *
         * @param x x location
         * @param y y location
         * @param timeout longest time the robot can spend moving, it takes 2x the timeout to complete the motion
         * @param params struct to simulate named parameters
         * @param async whether the function should be run asynchronously. true by default
         */
        void turnAndMoveToPoint(float x, float y, int timeout, MoveToPointParams params = {}, bool async = true);

        /**
         * @brief Move the chassis a certain distance
         *
         * @param dist the distance to move. Units in inches
         ...
         * @param async whether the function should be run asynchronously. true by default
         */
        void moveForward(float dist, int timeout, MoveToPointParams params = {}, bool async = true);
        /**
